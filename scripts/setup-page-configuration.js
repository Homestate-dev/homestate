...
async function setupPageConfiguration() {
  const pool = new Pool(dbConfig);
  
  try {
    console.log('🚀 Configurando tabla page_configuration para HomEstate...\n');
    ...
    console.log('2. Ahora puedes conectar el componente PageConfiguration a la base de datos');
    console.log('3. Los campos whatsapp_number y tally_link están disponibles');
...
if (require.main === module) {
  setupPageConfiguration().catch(console.error);
}
