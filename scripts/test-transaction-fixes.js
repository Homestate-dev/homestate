 ...
 * - Valor de transacción se guarda correctamente
 * - Fecha de reserva funciona
 * - Comisión para arriendo muestra solo valor
 */
...
async function testTransactionFixes() {
  ...
  try {
    console.log('🧪 PRUEBA DE FIXES DE TRANSACCIONES')
    console.log('====================================\n')
    ...
    existingResult.rows.forEach((row, index) => {
      ...
      console.log(`      Comisión: $${row.comision_valor?.toLocaleString() || 'N/A'} (${row.comision_porcentaje || 0}%)`)
    ...
    try {
      ...
      console.log('• ✅ Fecha de reserva funciona')
      console.log('• ✅ Comisión para venta muestra valor y porcentaje')
      console.log('• ✅ Comisión para arriendo muestra solo valor')
      console.log('• ✅ Estado inicial "reservado" se asigna correctamente')
